...
public class EventService {
    ...
    public List<EventDTO> parseTest(String rootUrl, String newSuffix, String className) throws Exception {
        Class<?> cls = Class.forName("news.crawler.service.executor." + className);
        Constructor<?> constructor = cls.getConstructor();
        Execute execClass = (Execute) constructor.newInstance();

        return execClass.execute(new SourceConfig("https://" + rootUrl, "/" + newSuffix));
